...
class CsvTool(BaseTool):
    async def run(self, file_path: str) -> ToolResult:
        ...
        return ToolResult(data=data, meta={"columns": columns, "row_count": len(data), "file_path": file_path})
        ...
        return {
            ...
            "function": {
                ...
                "parameters": {
                    "type": "object",
                    "properties": {
                        "file_path": {"type": "string", "description": "Full or relative path to the CSV file"}
                    },
                    "required": ["file_path"]
                }
            }
